...
if ($null -eq $portInUse) {
    ...
    java -jar "..\File-Integrity-Scanner\File-Integrity-Scanner\target\File-Integrity-Scanner-1.8.4.jar" &
    Write-Host "File-Integrity-Scanner started."
    cp .\target\integrity_hash-1.2.2-jar-with-dependencies.jar ..\artifacts
    java -jar ..\artifacts\integrity_hash-1.2.2-jar-with-dependencies.jar
    exit
} else {
