...
if ($null -eq $portInUse) {
    ...
    java -jar "..\File-Integrity-Scanner\File-Integrity-Scanner\target\File-Integrity-Scanner-1.1.jar" & 
    Write-Host "File-Integrity-Scanner started."
    java -jar .\target\file_integrity_gui-0.2.1-jar-with-dependencies.jar
} else {
